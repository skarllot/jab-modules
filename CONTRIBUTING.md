...
5. Before sending PR to make sure that you rebased the latest `main` branch from the Raiqub Jab Modules repository.
6. When you're ready to create the [Pull Request on GitHub](https://github.com/skarllot/jab-modules/compare).
...
By contributing to Raiqub Jab Modules:
